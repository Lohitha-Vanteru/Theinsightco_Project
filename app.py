...
@login_is_required
def protected_area():
    return f"<script type='module' src='https://public.tableau.com/javascripts/api/tableau.embedding.3.latest.min.js'></script>Hello {session['name']}! <br/> <a href='/logout'><button>Logout</button></a><tableau-viz id='tableauViz' src='https://10az.online.tableau.com/t/theinsightco/views/theinsightco/sourcewisejobcount?:origin=card_share_link&:embed=n'></tableau-viz>"  #the logout button 
